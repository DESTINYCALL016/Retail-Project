...
-- 1. Are there any duplicate product IDs?
Select *
from
product_info
 ...
 With Paid_Amount as(
	Select order_id,
	cast(sum(payment_value) over (partition by order_id) as numeric(30,2) )as Total_Paid
	from
	Orders_Payment_Raw
	),Amount_ToBe_Paid as
...
Select PA.order_id, Total_bill,Total_Paid
from
